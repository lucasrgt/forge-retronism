...
public class Aero_ModelRenderer {
    ...
    /**
     * Renderização no Inventário com a AeroModel API.
     */
    public static void renderInventory(RenderBlocks rb, Aero_Model model, float metadata) {
        // AeroAPI simplifies inventory rendering! 
        // We just use our world renderer but at [0,0,0] with fixed brightness.
        renderModel(model, -0.5, -0.5, -0.5, 0, 1.0f);
    }
}
